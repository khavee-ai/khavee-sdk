...
Last activity: 2026-07-09 - Completed quick task 260709-g4v: fixed cross-repo bug where WP plugin's platform-synced Instructions field showed only a voice-tone fragment instead of the full personality+voice composed prompt (ported khavee-app's buildPersonalityInstructions() into PHP), fully live-verified
</content>
